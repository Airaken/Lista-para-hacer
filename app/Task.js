                ...
                <div className="card">
                    <ul className="nav nav-tabs" id="myTab" role="tablist">
                        <li className="nav-item">
                            <a className="nav-link active" id="task-tab" data-toggle="tab"  role="tab" aria-controls="task" aria-selected="true">Task</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" id="users-tab" data-toggle="tab"  role="tab" aria-controls="users" aria-selected="false">Users</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" id="status-tab" data-toggle="tab"  role="tab" aria-controls="status" aria-selected="false">Status</a>
                        </li>
                        <li className="nav-item mx-auto">
                            <span  className={`nav-item status badge `}>{this.state.status}</span>
                        </li>
                    </ul>
                    <div className="tab-content" id="tabContent">
                        {/* tab of task info */}
                        <div className="tab-pane fade show active"  role="tabpanel" aria-labelledby="task-tab">
                            {/* tthis is body card, it have name of task and message of task */}
                            <div className="card-body">
                                <input onChange={this.handlerOnChange} disabled={this.state.disabled} value={this.state.name} name="name" type="text" className={`card-title form-control task-title`} />
                        ...
                        {/* tab of users */}
                        <div className="tab-pane fade" role="tabpanel" aria-labelledby="users-tab">
                            <div className="card-body">
                                <button data-toggle="modal" 
                                    className="m-1 mb-3 badge badge-primary" type="button">Assign User</button>
                                <div  className="modal fade"  tabIndex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                                    <div className="modal-dialog modal-dialog-scrollable" role="document">
                                        <div className="modal-content">
                                            <div className="modal-header">
                                                <h5 className="modal-title" id="exampleModalScrollableTitle">Assign users to </h5>
